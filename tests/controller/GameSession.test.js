...
const { log, incorrectLog, levels, games } = require("../data/GameSession.data.js");
...
beforeEach(async () => {
    ...
    let gameObj = new GameSession(games[0]);
    const levelList = await LevelSession.insertMany(levels);
    levelList.forEach(r => {
